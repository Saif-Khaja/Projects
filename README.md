...
### Modelling
I work with a lot of time series data so usually I will forecast the data using a ARIMA model for few series or a smoothing model if the volume of series are large. To do this I use the forecast library and [book]([url](https://otexts.com/fpp3/appendix-using-r.html)) written by Rob J Hyndman and others . 
